...
IF NOT EXISTS (SELECT 1 FROM tbl_parametre WHERE Grup = 'genel' AND Kod = 'gorusme_hatirlatma_gun')
BEGIN
...
IF NOT EXISTS (SELECT 1 FROM tbl_parametre WHERE Grup = 'genel' AND Kod = 'teklif_gecerlilik_hatirlatma_gun')
BEGIN
    INSERT INTO tbl_parametre (Grup, Kod, Deger, Etiket, Sira, Aktif, Varsayilan) 
...
IF NOT EXISTS (SELECT 1 FROM tbl_parametre WHERE Grup = 'genel' AND Kod = 'sozlesme_hatirlatma_gun')
BEGIN
    INSERT INTO tbl_parametre (Grup, Kod, Deger, Etiket, Sira, Aktif, Varsayilan) 
...
IF NOT EXISTS (SELECT 1 FROM tbl_parametre WHERE Grup = 'genel' AND Kod = 'damgavergisi_hatirlatma_gun')
BEGIN
    INSERT INTO tbl_parametre (Grup, Kod, Deger, Etiket, Sira, Aktif, Varsayilan) 
...
IF NOT EXISTS (SELECT 1 FROM tbl_parametre WHERE Grup = 'genel' AND Kod = 'fatura_hatirlatma_gun')
BEGIN
    INSERT INTO tbl_parametre (Grup, Kod, Deger, Etiket, Sira, Aktif, Varsayilan) 
...
IF NOT EXISTS (SELECT 1 FROM tbl_parametre WHERE Grup = 'genel' AND Kod = 'odeme_hatirlatma_gun')
BEGIN
    INSERT INTO tbl_parametre (Grup, Kod, Deger, Etiket, Sira, Aktif, Varsayilan) 
