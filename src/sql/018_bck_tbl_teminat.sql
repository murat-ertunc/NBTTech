...
IF OBJECT_ID('bck_tbl_teminat', 'U') IS NULL
BEGIN
...
IF NOT EXISTS (SELECT 1 FROM sys.indexes WHERE name = 'IX_bck_tbl_teminat_KaynakId' AND object_id = OBJECT_ID('bck_tbl_teminat'))
